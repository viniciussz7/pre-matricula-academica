...
export class StudentModalComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes['studentToEdit'] && this.studentToEdit) {
      ...
      this.form.patchValue(this.studentToEdit);
    } else {
  ...
  onSubmit() {
    ...
    const request$ = (this.isEditMode && this.studentToEdit?.id)
      ? this.service.update(this.studentToEdit.id, this.form.value)
